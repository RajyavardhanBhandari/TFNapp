...
export default function Settings(){
  const theme=useAppTheme();const router=useRouter();const {signOut,user}=useAuth();const [consent,setConsent]=useState(false);const [phone,setPhone]=useState('');
