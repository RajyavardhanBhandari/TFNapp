...
export default function Interests() {
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      if (active) {
        if (error) setMessage('Could not load your interests.');
...
const styles = StyleSheet.create({
  wrap: { maxWidth: 620, width: '100%', alignSelf: 'center', padding: 20, paddingBottom: 48 },
  eyebrow: { fontSize: 12, fontWeight: '900', letterSpacing: 1.5, marginBottom: 10 },
  title: { fontSize: 32, lineHeight: 38, fontWeight: '900' },
  body: { fontSize: 16, lineHeight: 24, marginTop: 10, marginBottom: 24 },
  loading: { alignItems: 'center', gap: 12, paddingVertical: 32 },
  chips: { flexDirection: 'row', flexWrap: 'wrap', gap: 8 },
  chip: { paddingHorizontal: 13, paddingVertical: 11, borderWidth: 1, borderRadius: 20 },
  button: { minHeight: 52, borderRadius: 14, alignItems: 'center', justifyContent: 'center', marginTop: 28 },
  cancel: { alignItems: 'center', padding: 18 },
  message: { marginTop: 14, fontSize: 14, lineHeight: 20 },
});