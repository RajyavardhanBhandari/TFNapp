...
export default function HomeScreen() {
  ...
  return (
    <Screen scroll={false} padding={false}>
      ...
      >
        {loading ? <><Skeleton large /><Skeleton /><Skeleton /></> : error && !data ? (
          ...
          <>
            ...
            <Section eyebrow="THE ECOSYSTEM" title="Trending" action="Explore" onAction={() => router.push('/(tabs)/discover')}>
              <Pressable accessibilityRole="button" accessibilityLabel="Open Trending" onPress={() => router.push('/(tabs)/discover')} style={({ pressed }) => [styles.trending, { backgroundColor: theme.colors.surfaceElevated, borderColor: theme.colors.border }, pressed && styles.pressed]}>
